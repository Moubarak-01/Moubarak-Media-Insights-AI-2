...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M15 8.142V9a3 3 0 0 0 3 3h1"/>
        <path d="M9 8.142V9a3 3 0 0 1-3 3H5"/>
        <path d="M6.007 5.142A3 3 0 0 0 6 5"/>
        <path d="M17.993 5.142A3 3 0 0 1 18 5"/>
        <path d="M12 14a3 3 0 1 0-5.993-.142"/>
        <path d="M18 14a3 3 0 1 0-5.993-.142"/>
        <path d="M15 16.858V16a3 3 0 0 0-3-3h-1"/>
        <path d="M9 16.858V16a3 3 0 0 1 3-3h1"/>
        <path d="M6.007 13.858A3 3 0 0 1 6 14"/>
        <path d="M17.993 13.858A3 3 0 0 0 18 14"/>
        <path d="M5 12h-1"/>
        <path d="M19 12h1"/>
        <path d="M12 19v1"/>
        <path d="M12 4v-1"/>
...
export const BrandIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" {...props}>
    ...
    <path d="M12 8a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" transform="rotate(120 12 12) translate(0 4)"/>
    <path d="M12 8a4 4 0 1 0 0-8 4 4 0 0 0 0 8z" transform="rotate(240 12 12) translate(0 4)"/>
  </svg>
);
...
export const UserFemaleIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M18 22a2 2 0 0 0 2-2v-1.46a2 2 0 0 0-1.1-1.79l-1.85-.92a2 2 0 0 1-1.1-1.79V12a2 2 0 0 0-2-2h-2a2 2 0 0 0-2 2v2.04a2 2 0 0 1-1.1 1.79l-1.85.92A2 2 0 0 0 4 18.54V20a2 2 0 0 0 2 2Z"/>
...
export const SpinnerIcon: React.FC<React.HTMLAttributes<HTMLDivElement>> = ({ className, ...props }) => (
    <div
        className={`border-2 border-slate-400 border-t-yellow-400 rounded-full animate-spin ${className}`}
        {...props}
    ></div>
);
